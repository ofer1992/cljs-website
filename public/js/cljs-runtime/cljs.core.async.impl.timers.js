...
var i_11480 = (0);
while(true){
if((i_11480 < arr.length)){
(arr[i_11480] = null);

var G__11481 = (i_11480 + (1));
i_11480 = G__11481;
continue;
} else {
}
...
var i_11493 = (self__.level + (1));
while(true){
if((i_11493 <= (new_level + (1)))){
(update[i_11493] = self__.header);

var G__11496 = (i_11493 + (1));
i_11493 = G__11496;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_11498 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_11498[i]));
} else {
x__$2.forward.push((((i < links_11498.length))?(links_11498[i]):null));
}

if((i < links_11498.length)){
(links_11498[i] = x__$2);
} else {
links_11498.push(x__$2);
}
...
var i_11507 = (0);
while(true){
if((i_11507 <= self__.level)){
var links_11508 = (update[i_11507]).forward;
if((x__$1 === (((i_11507 < links_11508.length))?(links_11508[i_11507]):null))){
(links_11508[i_11507] = (x__$1.forward[i_11507]));

var G__11509 = (i_11507 + (1));
i_11507 = G__11509;
continue;
} else {
var G__11510 = (i_11507 + (1));
i_11507 = G__11510;
continue;
}
} else {
...
var G__11514 = nx;
var G__11515 = (level__$1 - (1));
x = G__11514;
level__$1 = G__11515;
continue;
} else {
var G__11517 = x;
var G__11518 = (level__$1 - (1));
x = G__11517;
level__$1 = G__11518;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__11523 = nx;
var G__11524 = (level__$1 - (1));
x = G__11523;
level__$1 = G__11524;
continue;
} else {
var G__11525 = x;
var G__11526 = (level__$1 - (1));
x = G__11525;
level__$1 = G__11526;
continue;
}
