...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_11607 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_11607(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_11608 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_11608(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_11611 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_11611(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_11612 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_11612(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_11613 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_11613(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_11614 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_11614(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__11604,callback){
var map__11605 = p__11604;
var map__11605__$1 = cljs.core.__destructure_map(map__11605);
var input = map__11605__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11605__$1,new cljs.core.Keyword(null,"code","code",1586293142));
